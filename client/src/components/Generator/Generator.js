  ...
  return (
    <div className="columns-6 flex flex-row w-full justify-between border-black justify-around">
      <div className="w-40 h-[90px] bg-gray-800 rounded my-6">
        ...
        <div className="mb-20">
          <button
            className="absolute flex items-center justify-center mx-[48px] hover:text-green-300 hover:rounded text-gray-800 transform transition-all duration-300 hover:scale-110"
